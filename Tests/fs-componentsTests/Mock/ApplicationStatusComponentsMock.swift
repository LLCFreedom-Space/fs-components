...
//
//  ApplicationStatusComponentsMock.swift
//
//
...
import Vapor
@testable import ApplicationStatusComponents

public struct ApplicationStatusComponentsMock: ApplicationStatusComponentsProtocol {
