...
extension Application {
    /// A `ConsulComponentsKey` conform to StorageKey protocol
    ...
    /// Setup `consulComponents` in application storage
...
extension Application {
    /// A `ConsulConfigurationKey` conform to StorageKey protocol
    private struct ConsulConfigurationKey: StorageKey {
        /// Less verbose typealias for `ConsulConfiguration`.
        typealias Value = ConsulConfiguration
    }

    /// Setup `consulConfiguration` in application storage
